...
LastEditors: zhc
LastEditTime: 2023-10-31 22:47:15
'''
import os
import torch
...
if __name__ == '__main__':
    ...
    model = ResNetModel()
    resnet = model.resnet50(pretrained=False,progress=True)
    ...
    model_path = 'weight/model_500.pth'
    ...
    for epoch in range(epochs):
        ...
        # 每100个epoch保存一次模型
        if (epoch+1) % 100 == 0:
            torch.save(resnet.state_dict(), 'weight/model_%d.pth' % (epoch + 1))
